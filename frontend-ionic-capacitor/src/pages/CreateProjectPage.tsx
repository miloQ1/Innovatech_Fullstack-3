...
import { IonButton, IonCard, IonCardContent, IonInput, IonItem, IonList, IonTextarea, IonText } from '@ionic/react';
import { clientService, projectService } from '../api/projectService';
import type { Client, CreateProjectRequest } from '../types/projects';
...
export function CreateProjectPage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    setError(null);
    try {
      const data: CreateProjectRequest = { code, name, description: description || undefined, status: 'IN_PROGRESS', startDate: startDate || undefined, endDate: endDate || undefined };
