...
CREATE TABLE `projects` (
  ...
  CONSTRAINT `FKksdiyuily2f4ca2y53k07pmq` FOREIGN KEY (`client_id`) REFERENCES `clients` (`client_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `assignments` (
  ...
  KEY `FK6ku88wjd4f2h9u4pqf1fh1128` (`resource_id`),
  CONSTRAINT `FK6ku88wjd4f2h9u4pqf1fh1128` FOREIGN KEY (`resource_id`) REFERENCES `professionals` (`resource_id`)
