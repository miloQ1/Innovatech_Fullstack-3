...
import { IonBadge, IonButton, IonCard, IonCardContent, IonInput, IonItem, IonList, IonSelect, IonSelectOption, IonSpinner, IonText } from '@ionic/react';
          ...
          {projects.length === 0 ? <IonCard className="app-card"><IonCardContent><p className="muted">Este cliente todavía no tiene proyectos.</p></IonCardContent></IonCard> : (
            <div className="card-grid">
              {projects.map((project) => {
                ...
                return (
                  <IonCard key={projectId ?? project.code} className="app-card clickable" button onClick={() => projectId && history.push(`/projects/${projectId}`)}>
                    <IonCardContent>
